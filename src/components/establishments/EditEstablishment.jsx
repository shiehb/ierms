...
export default function EditEstablishment({
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <p className="text-sm font-medium text-amber-800">
              Modifying the address or coordinates will clear the existing
              polygon boundary. You will need to redraw the polygon after
              saving.
            </p>
          </div>
        </div>
  ...
  const confirmEdit = async () => {
    ...
    try {
      ...
      notifications.success("Establishment updated successfully!", {
      ...
      const hasNoPolygon =
        !establishmentData?.polygon || establishmentData.polygon.length === 0;
  ...
  const Label = ({ field, children }) => {
    ...
    return (
      <label className="flex items-center justify-between text-sm font-medium text-gray-700">
        ...
        {field === "name" && formData.name && !errors.name && nameExists && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              {!nameExists &&
                ...
                formData.name.trim() &&
                !errors.name &&
                formData.name !== establishmentData?.name && (
                  <div className="absolute right-3 top-3">
                    <svg
